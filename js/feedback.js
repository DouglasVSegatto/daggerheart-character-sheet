...
if (location.hostname === 'segattobuilder.github.io') {
  ...
  banner.innerHTML = '🚀 This page will shut down on <strong style="color:#d4a017">September 30</strong>. Save your session and switch to the new link: <a href="https://daggerheart-character-sheet.pages.dev" style="color:#d4a017;font-weight:bold;text-decoration:underline">daggerheart-character-sheet.pages.dev</a> <button onclick="this.parentElement.remove()" style="margin-left:16px;color:#6b5d4d;font-size:18px;background:none;border:none;cursor:pointer">✕</button>';
